...
import com.eeg_server.netP5.AbstractTcpClient;
import com.eeg_server.netP5.Logger;
import com.eeg_server.netP5.NetAddress;
import com.eeg_server.netP5.NetAddressList;
import com.eeg_server.netP5.NetInfo;
import com.eeg_server.netP5.TcpClient;
import com.eeg_server.netP5.TcpPacket;
import com.eeg_server.netP5.TcpPacketListener;
import com.eeg_server.netP5.TcpServer;
import com.eeg_server.netP5.UdpPacketListener;
...
public class OscP5 implements UdpPacketListener, TcpPacketListener {
    ...
    public OscP5(final Object theParent, final OscProperties theProperties) {
        ...
        if (_myOscProperties.networkProtocol() == OscProperties.MULTICAST) {
        	System.out.println("OscP5 is joining a multicast group @ " + _myOscProperties.remoteAddress().address() + ":" + _myOscProperties.remoteAddress().port());
        } else {
            System.out.println("OscP5 is running. you (" + ip() + ") are listening @ port " + _myOscProperties.remoteAddress().port());
        }
    }
